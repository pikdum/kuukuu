defmodule KuukuuWeb.Router do
  ...
  scope "/", KuukuuWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{KuukuuWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", KuukuuWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{KuukuuWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", KuukuuWeb do
    ...
    live_session :current_user,
      on_mount: [{KuukuuWeb.UserAuth, :mount_current_user}] do
